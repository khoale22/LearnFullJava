...
public class TreeMapTest {
    ...
    public static void main(String[] args) {
        ...
        cityMap.put(new Key2(2, "ND"), "New Delhi");
        cityMap.put(new Key2(3, "NW"), "Newark");
        cityMap.put(new Key2(4, "NP"), "Newport");

        System.out.println("size before iteration " + cityMap.size());
        Iterator<Key2> itr = cityMap.keySet().iterator();
        while (itr.hasNext()){
